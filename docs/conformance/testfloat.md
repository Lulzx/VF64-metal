...
result. Supported operations are currently `f64_add`, `f64_sub`, `f64_mul`, and
`f64_div` under all five IEEE rounding directions.
...
- square root and fused FMA remain blocking M1 operations.
