...
| M2 IEEE runtime | In progress | all M1 operations and modes pass TestFloat result plus exception flags; tininess-after-rounding | conversions, comparisons, remainder, round-to-integer and complete NaN/payload policy |
