...
| M2 IEEE runtime | In progress | add/sub flags pass TestFloat in all modes; tininess-after rounding implemented for these ops | remaining operation flags, conversions, comparisons, remainder, round-to-integer and complete NaN policy |
