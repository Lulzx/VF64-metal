...
| M2 IEEE runtime | In progress | all M1 flags, comparisons, remainder, round-to-integer, and integer-to-f64 conversions pass TestFloat | f64-to-integer/format conversions and complete NaN/payload policy |
