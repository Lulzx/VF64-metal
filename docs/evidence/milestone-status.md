...
| M2 IEEE runtime | In progress | core flags, comparisons, remainder, round-to-integer, integer and f16/f32 format conversions pass TestFloat | freeze complete NaN/payload policy and runtime ABI |
