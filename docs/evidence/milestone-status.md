...
| --- | --- | --- | --- |
| M1 exact core | In progress | GPU add/sub/mul/div/sqrt TestFloat result bridge for all IEEE rounding directions | true fused FMA and complete TestFloat matrices |
