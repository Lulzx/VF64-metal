...
| M7 workloads | In progress | M4 Pro pilot covers CG, GMRES, synthetic and two checksum-pinned external CSR matrices, GEMV, GEMM, four structured LP families, multi-step N-body, plus a VF64-integrated three-mode CuMetal CUDA workload | energy, general sparse LP validation, and cross-device reproduction |
