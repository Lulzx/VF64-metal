...
| --- | --- | --- | --- |
| M1 exact core | In progress | 31,599,360 level-1 GPU TestFloat result comparisons; zero mismatches; all core ops/modes | freeze broader corpus policy and M1/M2 conformance boundary |
