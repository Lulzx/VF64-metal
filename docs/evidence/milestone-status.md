...
| --- | --- | --- | --- |
| M1 exact core | In progress | GPU add/sub/mul/div/sqrt/true-FMA TestFloat result bridge for all IEEE rounding directions | complete release TestFloat matrices and artifacts |
