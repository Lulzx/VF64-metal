...
| M2 IEEE runtime | In progress | all M1 flags plus six comparison operations pass TestFloat; tininess-after-rounding | conversions, remainder, round-to-integer and complete NaN/payload policy |
