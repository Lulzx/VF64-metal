...
| M2 IEEE runtime | In progress | core flags, comparisons, remainder, round-to-integer, and all signed/unsigned integer conversions pass TestFloat | binary format conversions and complete NaN/payload policy |
